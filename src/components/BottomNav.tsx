        ...
        <div className="mx-auto flex max-w-lg items-stretch">
          ...
          <div className="flex flex-1 items-center justify-center">
            <button
              ...
              className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-500 text-white shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-400 active:scale-95"
            >
          ...
          <button
            ...
            className={`flex flex-1 flex-col items-center gap-0.5 py-2.5 text-[11px] font-medium transition ${
              moreActive ? 'text-emerald-500' : 'text-ink-faint'
            }`}
          >
...
function NavButton({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex flex-1 flex-col items-center gap-0.5 py-2.5 text-[11px] font-medium transition ${
        active ? 'text-emerald-500' : 'text-ink-faint'
      }`}
    >
